...
/**
 * Smart Diff module — deterministic, risk-ordered composition of a PR's
 * `pr_files` + its latest review's findings. No LLM call, no GitHub fetch.
 *
 *   GET /pulls/:id/smart-diff → the SmartDiff for the PR
 */
